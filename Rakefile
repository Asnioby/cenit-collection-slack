...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = 'cenit-collection-slack'
  gem.license = "MIT"
  gem.summary = 'Shared Collection cenit-collection-slack to be use in Cenit'
  gem.description = 'Shared Collection cenit-collection-slack to be use in Cenit'
  gem.author = 'Asnioby Hdez'
  gem.email = 'asnioby@gmail.com'
  gem.homepage = 'https://github.com/asnioby/cenit-collection-slack'
...
task :create_repo do
  options = {
    project_name: 'cenit-collection-slack', 
    user_name: 'Asnioby Hdez', 
    user_email: 'asnioby@gmail.com',
    github_username: 'asnioby',
    summary: 'Shared Collection cenit-collection-slack to be use in Cenit',
    description: 'Shared Collection cenit-collection-slack to be use in Cenit',
    homepage: 'https://github.com/asnioby/cenit-collection-slack',
...
require File.expand_path(File.join(*%w[ lib cenit collection slack]), File.dirname(__FILE__))
task :push do
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title = "cenit-collection-slack #{version}"
