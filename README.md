This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-slack.

Cenit is an open source social platform as a service for data and business integration.

# CenitCollectionSlack
...
Or install it yourself as:
    ...
    $ gem install cenit-collection-slack
...
% tree
.
├── cenit-collection-cenit-collection-slack.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-slack
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-slack.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-slack_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
...
1. Fork it ( https://github.com/[my-github-username]/cenit-collection-slack/fork )
